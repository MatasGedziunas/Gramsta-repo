...
<head>
    ...
    <link rel="stylesheet"
          href={{asset("cssStyles/clone.css")}}>
</head>
<body>
          ...
          <div class="wrapper" id="div">
            <article class="article" id="article">
              <div class="content" id ="div">
                  ...
                  <div class="form-wrap"  id ="div">
                    ...
                    @csrf
                      <div class="input-box"  id ="div">
                        <input type="text" id = "name" name="name" value="{{old('name')}}" aria-describedby="" placeholder="Username" aria-required="true" maxlength="30" autocapitalize="off" autocorrect="off" value="" required>
                      @error('name')
                ...
                <div class="login-box"  id ="div">
                  <p class="text">Already have an account?<a href="/user/login">Log in</a></p>
                </div> <!-- Signup-box end -->
              </div> <!-- Content end -->
            </article>
          </div> <!-- Wrapper end -->
